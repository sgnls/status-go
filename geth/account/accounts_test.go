...
func TestVerifyAccountPassword(t *testing.T) {
	accManager := account.NewManager(nil)
...
func TestManagerTestSuite(t *testing.T) {
	...
	accManager := account.NewManager(aMock)
...
func (s *ManagerTestSuite) TestCreateChildAccount() {
	...
	s.accManager.SetSelectedAccount(nil)
	s.T().Run("fail_noAccount", func(t *testing.T) {
		...
		s.Equal(account.ErrNoAccountSelected, err)
	})
...
func (s *ManagerTestSuite) TestAccounts() {
	...
	s.accManager = account.NewManager(s.account)
